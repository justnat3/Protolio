<footer class="overflow-hidden static w-full left-0 bottom-0 mt-20 bg-liver text-gray-100">
  ...
  >
    ...
    <!-- Padding left here for the name on the bottom left -->
  <!-- svelte-ignore a11y-invalid-attribute -->
    <a href="#" class="text-1xl pl-10 font-bold">Nathan Reed</a>
    <p class="mt-2 md:mt-0">All rights reserved 2020.</p>
    <!-- Padding right for this div to give room for the social icons -->
    <div class="flex mt-4 mb-2 pr-10 md:mt-0 md:mb-0">
        <!-- svelte-ignore a11y-invalid-attribute -->
